...
static const struct esp_netif_netstack_config s_eth_netif_br_config = {
        .lwip = {
...
const esp_netif_netstack_config_t *_g_esp_netif_netstack_br_default_eth   = &s_eth_netif_br_config;
